					...
					function( $atts, $content = null ) use ( $tag ) {
						...
						if ( 'products' == $tag && is_singular( PortoBuilders::BUILDER_SLUG ) ) {
							...
							if ( 'toggle' == $tag ) {
								...
								$params_keys = array( 'dots_pos_top', 'dots_pos_bottom', 'dots_pos_left', 'dots_pos_right', 'dots_abr_color', 'dots_bg_color', 'dots_abg_color', 'dots_original', 'dots_visible', 'nav_visible', 'nav_fs', 'nav_width', 'nav_height', 'nav_br', 'navs_h_origin', 'nav_h_pos', 'nav_v_pos', 'nav_color', 'nav_h_color', 'nav_bg_color', 'nav_h_bg_color', 'nav_br_color', 'nav_h_br_color', 'flick_opacity' );
							}
							$params = array();
