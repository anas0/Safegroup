...
class Instant{
	...
	$option_search_engine_bring = !empty($option_engines['bring']) ? $option_engines['bring'] : '';
				...
				<tr>
                    ...
                    <td> 
                        ...
                        <label for="siteseo_search_engines">
				            <input id="siteseo_search_engines" name="siteseo_options[search_engine_bring]" type="checkbox"' . (!empty($option_search_engine_bring) ? 'checked="yes"' : '') . ' value="1"/>'.esc_html__('Bing', 'siteseo') . 
			            '</label>
                    </td>
                </tr>
	...
	static function save_settings(){
		...
		if(isset($_POST['siteseo_options']['general'])){
			...
			$options['instant_indexing_google_action'] = isset($_POST['siteseo_options']['instant_indexing_actions']) ? sanitize_text_field(wp_unslash($_POST['siteseo_options']['instant_indexing_actions'])) : '';
			$options['instant_indexing_manual_batch'] = isset($_POST['siteseo_options']['instant_indexing_batch']) ? sanitize_text_field(wp_unslash($_POST['siteseo_options']['instant_indexing_batch'])) : '';
		}
