		...
		<table class="form-table"/>
			<tbody>
				...
				<tr>
					...
					<td>
						<input name="siteseo_options[bring_meta_value]" type="text" placeholder="'.esc_html__('Enter Google meta value site verification','siteseo').'" value="'.esc_attr($option_bring_meta_value).'"/>
