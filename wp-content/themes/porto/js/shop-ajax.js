...
( function( theme, $ ) {
    ...
    var ajaxFiltered = function( initLoad ) {
        ...
        if ( $( shop_container ).find( '.nothing-found-message' ).length || $( shop_wrap ).find( '.woocommerce-no-products-found' ).length ) {
            if ( typeof js_porto_vars != 'undefined' && '' == js_porto_vars.shop_filter_layout && ( ! theme.isTablet() || 0 == $( '.porto_product_filters-toggle' ).length ) ) {
                $shop_toolbox.hide().data( 'show', false );
            }
            if ( typeof js_porto_vars != 'undefined' && 'horizontal' == js_porto_vars.shop_filter_layout && theme.isTablet() && 0 == $( '.porto_product_filters-toggle.d-lg-none' ).length ) {
                $shop_toolbox.hide().data( 'show', false );
            }
