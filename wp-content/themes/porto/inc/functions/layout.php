...
function porto_search_form_content( $is_mobile = false ) {
	...
	<form action="<?php echo esc_url( home_url( '/' ) ); ?>" method="get"
		...
		<div class="searchform-fields<?php echo ( 'overlay' == $porto_settings['search-layout']  && ! $is_mobile ? ' container' : '' ); ?>">
			...
			<?php if ( isset( $porto_settings['search-type'] ) && ( 'event' === $porto_settings['search-type'] || 'post' === $porto_settings['search-type'] || 'product' === $porto_settings['search-type'] || 'portfolio' === $porto_settings['search-type'] ) ) : ?>
...
function porto_head_metas() {
	...
	if ( isset( $porto_settings_optimize['preload'] ) ) {
		...
		if ( in_array( 'sli', $porto_settings_optimize['preload'] ) ) {
			echo '<link rel="preload" href="' . PORTO_URI . '/fonts/Simple-Line-Icons/Simple-Line-Icons.woff2" as="font" type="font/woff2" crossorigin />';
		}
	}
