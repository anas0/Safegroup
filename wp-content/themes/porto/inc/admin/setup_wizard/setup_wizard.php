	...
	class Porto_Theme_Setup_Wizard {
		...
		public function porto_demo_types() {
			...
			return array(
				...
				'shop'                 => array(
					'alt'        => 'Shop Demo <small>(52 VARIATIONS)</small>',
					'slider_cat' => 'shop',
	...
	/*			'corporate2'           => array(
		...
		/*		'corporate13'          => array(
				...
				'shop52'               => array(
					...
					'plugins' => array( 'js_composer', 'woocommerce', 'yith-woocommerce-wishlist', 'contact-form-7', 'customer-reviews-woocommerce', 'yith-woocommerce-ajax-navigation', 'perfect-woocommerce-brands', 'yith-woocommerce-frequently-bought-together' ),
				),
				'shop51'               => array(
					'alt'     => 'Shop 51',
			...
			if ( 'shortcodes' != $demo ) {
				...
				if ( false !== strpos( $demo, 'elementor-' ) ) { // Elementor demo
					...
					if ( defined( 'ELEMENTOR_VERSION' ) && version_compare( ELEMENTOR_VERSION, '3.25.0' ) >= 0 ) {
						update_option( \Elementor\Plugin::$instance->experiments->get_feature_option_key( 'e_optimized_markup' ), \Elementor\Plugin::$instance->experiments::STATE_INACTIVE );
					}					
